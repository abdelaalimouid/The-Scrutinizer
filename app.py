...
def build_system_prompt() -> str:
    return (
        ...
        "'$15,000 growing to $115,000 in 18 months implies about 12% monthly compounding'). "
        "Avoid duplicated or garbled formulas, and prefer a short markdown table over complex notation.\n"
